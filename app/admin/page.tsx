...
const defaultContent: ContentData = {
    ...
    gallery: {
        featured: {
            ...
            images: [
                ...
                "https://images.unsplash.com/photo-1578731537866-30f1e9a9e9f9?w=600",
        ...
        testimonials: [
            {
                ...
                content: "The 3D animations transformed our product showcase. Customer engagement increased by 340%.",
                image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150"
            },
            {
                name: "Michael Chen",
                role: "CEO, Creative Studios",
                content: "Outstanding quality and incredibly fast turnaround. They're our go-to animation partner.",
                image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150"
            },
            {
                name: "Emma Davis",
                role: "Marketing Director, StartupXYZ",
                content: "Professional, creative, and detail-oriented. Every animation exceeded our expectations.",
    ...
    footer: {
        ...
        copyright: "© 2025 — TryQu Tech",
    },
    about: {
        title: "About TryQu Tech",
...
export default function AdminDashboard() {
         ...
         const checkAuth = () => {
             ...
             const timer = setTimeout(() => {
                 ...
                 if (sessionCookie && sessionCookie.includes("authenticated")) {
                      ...
                      const savedContent = localStorage.getItem("tryqu-content")
                      if (savedContent) {
                      ...
                      const savedActivity = localStorage.getItem("tryqu-activity")
                      if (savedActivity) {
    ...
    const handleSave = async () => {
        ...
        try {
             ...
             localStorage.setItem("tryqu-content", JSON.stringify(content))
             ...
             localStorage.setItem("tryqu-activity", JSON.stringify(updatedActivity))
        ...
        if (selectedPage === "home") {
            return (
                <div className="space-y-8">
                    ...
                    {/* Status Banner */}
                    <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-2xl p-6 text-white relative overflow-hidden">
                        ...
                        <div className="relative flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white">All Systems Active</h3>
                                    <p className="text-white/70">Your website is live with real-time content management.</p>
                                </div>
                            </div>
                            <Button onClick={handlePreview} className="bg-white text-cyan-600 hover:bg-white/90 font-bold px-6">
                                Preview Site →
                            </Button>
                        </div>
                    </div>

                    {/* Key Metrics Grid - Expanded */}
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-neutral-400 text-sm font-medium">Active Orders</p>
                                    ...
                                    <div className="h-1 bg-neutral-800 rounded-full overflow-hidden mt-2">
                                        <div className="h-full bg-[#C6FF3A] w-3/4 rounded-full" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-neutral-400 text-sm font-medium">Revenue</p>
                                    ...
                                    <div className="h-1 bg-neutral-800 rounded-full overflow-hidden mt-2">
                                        <div className="h-full bg-green-400 w-4/5 rounded-full" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-neutral-400 text-sm font-medium">Site Visitors</p>
                        ...
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-neutral-400 text-sm font-medium">Project Completion</p>
                                    ...
                                    <div className="h-1 bg-neutral-800 rounded-full overflow-hidden mt-2">
                                        <div className="h-full bg-purple-400 w-11/12 rounded-full" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    {/* Extended Metrics - 2 Additional Rows */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-neutral-400 text-sm font-medium">Avg. Project Value</p>
                                    ...
                                    <div className="h-1 bg-neutral-800 rounded-full overflow-hidden mt-2">
                                        <div className="h-full bg-orange-400 w-2/3 rounded-full" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-2 text-xs">
                                        <span className="text-green-400">↑ 12 reviews</span>
                                        <span className="text-neutral-400">this month</span>
                                    </div>
                                    <div className="h-1 bg-neutral-800 rounded-full overflow-hidden mt-2">
                                        <div className="h-full bg-pink-400 w-11/12 rounded-full" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-neutral-700 hover:border-neutral-600 transition-colors">
                            <CardContent className="p-6">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-neutral-400 text-sm font-medium">Turnaround Time</p>
                                        <Video className="h-4 w-4 text-cyan-400" />
                                    </div>
                                    <p className="text-3xl font-bold text-white">18 days</p>
                                    <div className="flex items-center gap-2 text-xs">
                                        <span className="text-green-400">↓ 2 days</span>
                                        <span className="text-neutral-400">faster than target</span>
                                    </div>
                                    <div className="h-1 bg-neutral-800 rounded-full overflow-hidden mt-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <Card className="bg-[#1a1a1a] border-neutral-800 lg:col-span-2">
                            <CardHeader>
                                <CardTitle className="text-white">Content Overview</CardTitle>
                                <p className="text-neutral-400 text-sm">Manage your website sections</p>
                            </CardHeader>
                            <CardContent>
                                <div className="grid grid-cols-2 gap-3">
                                    {[
                                        { name: "Hero Section", status: "Published", icon: "🏠", color: "border-[#C6FF3A]" },
                                        { name: "Features", status: "Updated", icon: "⭐", color: "border-blue-400" },
                                        { name: "Pricing Plans", status: "Published", icon: "💰", color: "border-green-400" },
                                        { name: "About Page", status: "Draft", icon: "ℹ️", color: "border-purple-400" },
                                    ].map((item, i) => (
                                        <div key={i} className={`p-4 rounded-lg bg-[#0f0f0f] border-l-4 ${item.color} cursor-pointer hover:bg-[#151515] transition-colors`}>
                        ...
                        <Card className="bg-[#1a1a1a] border-neutral-800">
                            ...
                            <CardContent className="space-y-3">
                                <Button
                                    ...
                                    className="w-full justify-start bg-[#0f0f0f] hover:bg-neutral-800 text-white border-neutral-700"
                                    variant="outline"
                                >
                    ...
                    <Card className="bg-[#1a1a1a] border-neutral-800">
                        <CardHeader>
                            <CardTitle className="text-white">Featured Portfolio</CardTitle>
                            <p className="text-neutral-400 text-sm">Showcase of our latest work</p>
                        </CardHeader>
                        <CardContent>
                            <div className="relative rounded-xl overflow-hidden bg-[#0f0f0f] border border-neutral-800">
                                <img
                                ...
                                {/* Image Counter */}
                                <div className="absolute bottom-4 right-4 bg-black/60 px-3 py-1 rounded-full text-white text-sm font-medium">
                                ...
                                {galleryImages.map((image, index) => (
                                    <button
                                        ...
                                        className={`flex-shrink-0 w-16 h-16 rounded-lg border-2 overflow-hidden transition-colors ${
                                            currentGalleryIndex === index ? "border-[#C6FF3A]" : "border-neutral-700 hover:border-neutral-600"
                                        }`}
                                    >
                    ...
                    <Card className="bg-[#1a1a1a] border-neutral-800">
                        <CardHeader>
                            ...
                            <p className="text-neutral-400 text-sm">What our clients say about our work</p>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="p-6 rounded-xl bg-[#0f0f0f] border border-neutral-800 hover:border-neutral-700 transition-colors">
                                        ...
                                        <p className="text-neutral-300 text-sm leading-relaxed italic">"{testimonial.content}"</p>
                                        <div className="flex gap-1 mt-4">
                                            {[...Array(5)].map((_, i) => (
                                                <span key={i} className="text-[#C6FF3A]">★</span>
                                            ))}
                                        </div>
                                    </div>
                                ))}
                    ...
                    <Card className="bg-[#1a1a1a] border-neutral-800">
                        <CardHeader className="flex flex-row items-center justify-between">
                            <div>
                                ...
                                <p className="text-neutral-400 text-sm">Latest changes to your content</p>
                            </div>
                        ...
                        <CardContent className="space-y-3">
                            {currentActivityItems.map((item) => (
                                <div key={item.id} className="flex items-center justify-between p-4 rounded-lg bg-[#0f0f0f] border border-neutral-800/50 hover:border-neutral-700 transition-colors">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 bg-neutral-800/50 rounded-lg flex items-center justify-center border border-neutral-700">
                                            <span className="text-lg">{item.icon}</span>
                                        </div>
                                        <div>
                                            <p className="text-white font-medium text-sm">{item.name}</p>
                                            <p className="text-neutral-400 text-xs">
                                                {item.status} • {formatTimeAgo(item.timestamp)}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <span className="text-[#C6FF3A] font-semibold text-sm">{item.change}</span>
                                        <TrendingUp className="h-4 w-4 text-[#C6FF3A]" />
                                    </div>
                                </div>
                            ))}
                        </CardContent>
                    ...
                    <div className="absolute left-0 top-0 h-full w-64 bg-[#0f0f0f] border-r border-neutral-800">
                        <div className="p-6 border-b border-neutral-800 flex items-center justify-between">
                             <div className="flex items-center gap-3">
                                 ...
                                 <span className="text-xl font-semibold">TryQu</span>
                             </div>
