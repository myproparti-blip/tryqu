      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-white/10">
                <Image src="/images/intuitive-1.svg" alt="ArchViz material sample" fill className="object-cover" />
              </div>
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-white/10">
                <Image src="/images/intuitive-2.svg" alt="Interior lighting demo" fill className="object-cover" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="liquid-glass border border-white/20">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Image
                src={"/images/archviz/client-love-1.svg"}
                width={280}
                height={160}
              ...
              />
              <Image
                src={"/images/archviz/client-love-2.svg"}
                width={280}
                height={160}
