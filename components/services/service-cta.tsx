...
import { ArrowRight, Mail, Phone, MessageSquare, X, CheckCircle, AlertCircle } from "lucide-react"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                            Our expert team is ready to discuss how we can help you achieve your digital transformation goals.
                        </p>
                        ...
                        <div className="p-8">
                            ...
                            <div className="p-6 rounded-lg bg-blue-500/5 border border-blue-500/20 mb-8">
                                ...
                                <ul className="space-y-2 text-gray-300 text-sm">
                                    ...
                                    <li className="flex gap-2">
                                        <span className="text-cyan-400">✓</span>
                                        <span>You'll receive a follow-up email to schedule your consultation</span>
                                    </li>
                                </ul>
                            </div>
