                         ...
                         <DropdownMenu>
                             ...
                             <DropdownMenuContent align="end" className="w-auto bg-black/98 border border-lime-400/40 backdrop-blur-xl p-4">
                                 ...
                                 <div className="space-y-2">
                                     ...
                                     <a href="mailto:info@tryqu.com" className="flex items-center gap-3 px-3 py-2.5 cursor-pointer rounded-lg hover:bg-lime-400/20 transition-all text-white text-sm font-medium">
                                        ...
                                        {/* Contact Us Collapsible */}
                                         <details className="group">
                                             ...
                                             <div className="bg-neutral-950/60 border-l-2 border-neutral-700 ml-6 mt-0.5">
                                                 ...
                                                 <a href="mailto:info@tryqu.com" className="flex items-center gap-3 px-4 py-2.5 text-neutral-400 hover:text-lime-300 hover:bg-neutral-900/50 transition-colors">
